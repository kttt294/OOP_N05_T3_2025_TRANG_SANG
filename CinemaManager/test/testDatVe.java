...
public class testDatVe {
    public static void test() {
        ...
        TaiKhoan tk = new TaiKhoan("user1", "pass1", "KhachHang");
        // Tạo khách hàng
        KhachHang kh = new KhachHang("123456789", "Nguyen Van A", 25, "0123456789", "a@gmail.com", "Nam", new ArrayList<>(), tk);
        ...
        GheSuatChieu gsc = new GheSuatChieu("G01", "SC01", 50000, "BinhThuong", "Thuong", "");
        ...
        GheSuatChieu gscCheck = GheSuatChieu.getByMaGheAndMaSuatChieu("G01", "SC01");
        if (gscCheck != null) {
