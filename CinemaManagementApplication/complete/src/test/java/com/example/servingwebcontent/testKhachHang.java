...
public class testKhachHang {
    ...
    public static void testTinhTongTienKhachHang() {
        ...
        HoaDon.getDanhSachHoaDon().add(new HoaDon("HD001", new DoAn("DA001", "Bắp", 30000, 10), 30000, LocalDateTime.now(), HoaDon.PhuongThucThanhToan.TIEN_MAT, "K006"));
        HoaDon.getDanhSachHoaDon().add(new HoaDon("HD002", new DoAn("DA002", "Nước", 20000, 5), 20000, LocalDateTime.now(), HoaDon.PhuongThucThanhToan.CHUYEN_KHOAN, "K006"));
