...
public class testSuatChieuController {
    ...
    private static SuatChieuController controller = new SuatChieuController();
    ...
    public static void testHienThiSuatChieuTrongNgay() {
        ...
        assert controller.hienThiSuatChieuTrongNgay(danhSach) : "Hiển thị thất bại";
    ...
    public static void testTaoSuatChieu() {
        ...
        assert controller.taoSuatChieu(sc) : "Tạo suất chiếu thất bại";
    ...
    public static void testCapNhatSuatChieu() {
        ...
        assert controller.capNhatSuatChieu("SC002", scMoi) : "Cập nhật thất bại";
        System.out.println("✓ Cập nhật suất chiếu OK\n");
    }

    public static void testXoaSuatChieu() {
        System.out.println("=== TEST: XOÁ SUẤT CHIẾU ===");
        assert controller.xoaSuatChieu("SC002") : "Xoá suất chiếu thất bại";
    ...
    public static void testXemThongTinSuatChieu() {
        ...
        assert controller.xemThongTinSuatChieu("SC001") : "Xem suất chiếu thất bại";
    ...
    public static void testXemTatCaSuatChieu() {
        ...
        assert controller.xemTatCaSuatChieu() : "Xem tất cả suất chiếu thất bại";
    ...
    public static void testTimSuatChieuTheoMa() {
        ...
        SuatChieu sc = controller.timSuatChieuTheoMa("SC001");
    ...
    public static void testTimSuatChieuTheoPhim() {
        ...
        ArrayList<SuatChieu> list = controller.timSuatChieuTheoPhim("PHIM001");
    ...
    public static void testTimSuatChieuTheoPhong() {
        ...
        ArrayList<SuatChieu> list = controller.timSuatChieuTheoPhong("PHONG01");
