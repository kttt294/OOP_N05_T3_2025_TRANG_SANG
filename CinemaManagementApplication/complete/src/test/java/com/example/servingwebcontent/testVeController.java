...
public class testVeController {
    ...
    public static void testTimVeTheoKhachHang() {
        ...
        ArrayList<Ve> list = VeController.timVeTheoKhachHang("123456789");
    ...
    public static void testTimVeTheoSuatChieu() {
        ...
        ArrayList<Ve> list = VeController.timVeTheoSuatChieu("SC001");
