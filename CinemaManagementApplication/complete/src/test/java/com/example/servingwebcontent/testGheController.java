...
public class testGheController {
    ...
    public static void testTaoGhe() {
        ...
        Ghe ghe = new Ghe("GHE001", "PHONG01", 1, 2, "VIP");
    ...
    public static void testCapNhatGhe() {
        ...
        Ghe gheMoi = new Ghe("GHE001", "PHONG01", 3, 4, "Thuong");
        assert GheController.capNhatGhe("GHE001", gheMoi);
        Ghe ghe = Ghe.getGheByMaGhe("GHE001");
        assert ghe.getSoHang() == 3;
        assert ghe.getSoCot() == 4;
        assert "Thuong".equals(ghe.getLoai());
    ...
    public static void testXemThongTinGhe() {
        ...
        Ghe ghe = new Ghe("GHE002", "PHONG02", 5, 6, "VIP");
        Ghe.Create(ghe);
    ...
    public static void testXemTatCaGhe() {
        ...
        Ghe.Create(new Ghe("GHE003", "PHONG03", 2, 2, "Thuong"));
        Ghe.Create(new Ghe("GHE004", "PHONG03", 3, 3, "VIP"));
    ...
    public static void testTimGheTheoMa() {
        ...
        Ghe ghe = new Ghe("GHE005", "PHONG05", 1, 1, "VIP");
        Ghe.Create(ghe);
