...
public class testVoucherController {
    ...
    private static VoucherController controller = new VoucherController();
    ...
    public static void testXoaVoucher() {
        ...
        assert controller.xoaVoucher("VC001") : "Xoá voucher thất bại";
        System.out.println("✓ Xoá voucher OK\n");
    }

    public static void testXemThongTinVoucher() {
        System.out.println("=== TEST: XEM THÔNG TIN VOUCHER ===");
        assert controller.xemThongTinVoucher("VC001") : "Xem thông tin thất bại";
    ...
    public static void testXemTatCaVoucher() {
        ...
        assert controller.xemTatCaVoucher() : "Xem tất cả thất bại";
    ...
    public static void testTimVoucherTheoMa() {
        ...
        Voucher v = controller.timVoucherTheoMa("VC001");
    ...
    public static void testTimVoucherTheoTen() {
        ...
        ArrayList<Voucher> list = controller.timVoucherTheoTen("Giảm");
