...
public class testDoAnController {
    ...
    public static void testCapNhatDoAn() {
        ...
        boolean result = controller.capNhatDoAn("DA001", doAnMoi);
    ...
    public static void testXoaDoAn() {
        ...
        boolean result = controller.xoaDoAn("DA001");
    ...
    public static void testXemThongTinDoAn() {
        ...
        DoAn.Create(doAn);
        boolean result = controller.xemThongTinDoAn("DA002");
    ...
    public static void testXemTatCaDoAn() {
        ...
        boolean result = controller.xemTatCaDoAn();
    ...
    public static void testTimDoAnTheoMa() {
        ...
        DoAn doAn = controller.timDoAnTheoMa("DA002");
    ...
    public static void testTimDoAnTheoTen() {
        ...
        ArrayList<DoAn> results = controller.timDoAnTheoTen("khoai");
    ...
    public static void testCapNhatSoLuong() {
        ...
        boolean result = controller.capNhatSoLuong("DA002", 50);
    ...
    public static void testThongKeDoAn() {
        ...
        boolean result = controller.thongKeDoAn();
