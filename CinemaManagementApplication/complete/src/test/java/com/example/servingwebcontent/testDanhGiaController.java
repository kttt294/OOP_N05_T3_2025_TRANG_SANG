...
public class testDanhGiaController {
    ...
    private static DanhGiaController controller = new DanhGiaController();
    ...
    public static void testXoaDanhGia() {
        ...
        assert controller.xoaDanhGia("DG002") : "Xoá thất bại";
        assert !controller.xoaDanhGia("DG999") : "Không nên xoá được DG999";
    ...
    public static void testXemThongTin() {
        ...
        assert controller.xemThongTinDanhGia("DG001");
        assert !controller.xemThongTinDanhGia("KHONGTONTAI");
    ...
    public static void testXemTatCa() {
        ...
        assert controller.xemTatCaDanhGia();
    ...
    public static void testTimKiem() {
        ...
        DanhGia dg = controller.timDanhGiaTheoMa("DG001");
        assert dg != null : "Không tìm thấy đánh giá DG001";

        ArrayList<DanhGia> list = controller.timDanhGiaTheoKhachHang("123456789012");
    ...
    public static void testThongKe() {
        ...
        double avg = controller.tinhDiemTrungBinh();
        assert avg >= 0 && avg <= 5 : "Trung bình không hợp lệ";

        assert controller.thongKeDanhGia();
