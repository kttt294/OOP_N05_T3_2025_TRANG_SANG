...
public class Voucher {
    ...
    public void hienThiThongTin() {
        ...
        System.out.println("Ngày bắt đầu: " + (ngayBatDau != null ? DateTimeUtils.formatVietDateTime(ngayBatDau) : "Chưa đặt"));
        System.out.println("Ngày kết thúc: " + (ngayKetThuc != null ? DateTimeUtils.formatVietDateTime(ngayKetThuc) : "Chưa đặt"));
